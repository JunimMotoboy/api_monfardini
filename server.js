...
app.post("/horario_marcado", async(req, res)=>{
    ...
    const {horario, data, nome_funcionario, id_cliente, nome_cliente, valor, procedimento} = req.body
    const result = await pool.query("INSERT INTO horarios_marcados (horario, data, nome_funcionario, id_cliente, nome_cliente, valor, procedimento) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *", [horario, data, nome_funcionario, id_cliente, nome_cliente, valor, procedimento])
